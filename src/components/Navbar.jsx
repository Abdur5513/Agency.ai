...
function Navbar({theme ,setTheme}) {
 ...
 px-4 sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70'>
     <a href="/"> <img src={theme === 'dark' ? assets.logo_dark :assets.logo} className='w-32 sm:w-40' alt="" /></a>
...
flex sm:items-center gap-5 transition-all`}>
     ...
     <div className=' flex items-center gap-2 sm:gap-4'>
        ...
        <a href="#contact-us" className='text-sm max-sm:hidden flex items-center gap-3 bg-primary text-white px-6 py-2 rounded-full cursor-pointer hover:scale-103 transition-all'>
