...
function Hero() {
  return (
    <div className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700'>
       <div className='inline-flex items-center gap border border-gray-300 p-1.5 pr-4 rounded-full gap-3'>
...
<p className="text-sm sm:text-lg font-medium text-gray-500  w-4/5 sm:max-w-lg pb-3">
